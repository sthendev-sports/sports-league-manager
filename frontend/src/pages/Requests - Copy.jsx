...
const getRequestCounts = useMemo(() => {
    ...
    requests.forEach(req => {
      ...
      if (type.includes('move up')) counts.moveUp++;
      else if (type.includes('move down')) counts.moveDown++;
      else if (type.includes('teammate')) counts.teammate++;
      else if (type.includes('volunteer')) counts.volunteer++;
      else if (type.includes('admin')) counts.admin++;
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="text-sm bg-blue-50 text-blue-700 px-3 py-1 rounded-full font-medium">
              Total Requests: {getRequestCounts.total}
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
            ...
            <div className="bg-purple-50 rounded-lg p-3 border border-purple-100">
              ...
              <div className="text-2xl font-bold text-purple-700">{getRequestCounts.moveUp}</div>
            </div>
            
            <div className="bg-indigo-50 rounded-lg p-3 border border-indigo-100">
              <div className="text-xs text-indigo-600 font-medium uppercase tracking-wider">Move Down</div>
              <div className="text-2xl font-bold text-indigo-700">{getRequestCounts.moveDown}</div>
            </div>
            
            <div className="bg-pink-50 rounded-lg p-3 border border-pink-100">
              <div className="text-xs text-pink-600 font-medium uppercase tracking-wider">Teammate</div>
              <div className="text-2xl font-bold text-pink-700">{getRequestCounts.teammate}</div>
            </div>
            
            <div className="bg-orange-50 rounded-lg p-3 border border-orange-100">
              <div className="text-xs text-orange-600 font-medium uppercase tracking-wider">Volunteer</div>
              <div className="text-2xl font-bold text-orange-700">{getRequestCounts.volunteer}</div>
            </div>
          ...
          <div className="mt-3 text-xs text-gray-500">
            Showing {getRequestCounts.total} request{getRequestCounts.total !== 1 ? 's' : ''} for the selected season
          </div>
        </div>
      )}
